 ...
 *
 */
public class EMraterV2 implements AlgRater {
    ...
    private static final Pattern[][] TRIGGERS = {
            // TIER1
            {
                    ...
                    Pattern.compile("(r' B' r )|(R' b' R )|(B' r' B )|(b' R' b )"),
                    Pattern.compile("(b' B R' )|(B' R r' )|(r' b B' )|(R' r b' )")
            },
            // TIER2
            {
                    Pattern.compile("(r R r )|(R B R )|(B b B )|(b r b )"),
                    ...
                    Pattern.compile("(R' r R )|(B' R B )|(b' B b )|(r' b r )"),
                    Pattern.compile("(R' r' R )|(B' R' B )|(b' B' b )|(r' b' r )"),
                    Pattern.compile("(b' B r' )|(B' R b' )|(r' b R' )|(R' r B' )"),
                    Pattern.compile("(r b' B )|(b B' R )|(R r' b )|(B R' r )")
            },
            // TIER3
            {
                    Pattern.compile("(r R r' )|(R B R' )|(B b B' )|(b r b' )"),
            ...
            // BONUS2
            {
                    ...
                    Pattern.compile("(b' B r )|(B' R b )|(r' b R )|(R' r B )"),
                    Pattern.compile("(R b' B )|(r B' R )|(B r' b )|(b R' r )"),
